...
class Settings(BaseSettings):
    ...
    band_triage_agent_id: str | None = None
    band_triage_agent_api_key: str | None = None
    band_threat_intel_agent_id: str | None = None
    band_threat_intel_agent_api_key: str | None = None
    band_forensics_agent_id: str | None = None
    band_forensics_agent_api_key: str | None = None
    band_compliance_agent_id: str | None = None
    band_compliance_agent_api_key: str | None = None
    band_commander_agent_id: str | None = None
